...
RSpec.feature 'Infinite scroll', type: :feature do
  ...
  scenario 'User scrolls down the hobby page and posts list will be appended with older posts', :js do
  ...
  scenario 'User scrolls down the study page and posts list will be appended with older posts', :js do
  ...
  scenario 'User scrolls down the team page and posts list will be appended with older posts', :js do
